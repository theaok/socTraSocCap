...
An advantage of SHARE is few missing values, 
 and there is imputed dataset without any values missing (we collapse dataset--take an average across categories on implicat varliable). %also representative at nuts1 i guess!
...
\begin{table}[H]\centering \caption{OLS of SWB (life satisfaction and CASP) on
    volunteerring and pensions. Beta (fully standarized) coefficients reported. All models
    include country dummies.}  \begin{scriptsize} \begin{tabular}{p{1.8in}p{.5in}p{.5in}|p{.5in}p{.5in}p{.5in}p{.5in}p{.5in}p{.5in}p{.5in}p{.4in}p{.5in}p{.4in}}\hline \input{/tmp/shareElderly/regCw6.tex}
      \hline\multicolumn{5}{l}{+p$<$0.10 *p$<$0.05 **p$<$0.01 ***p$<$0.001,
